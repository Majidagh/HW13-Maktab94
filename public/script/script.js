...
loginBtn.addEventListener("click", (e) => {
  ...
  const promise = fetch(`https://64764200e607ba4797dd842e.mockapi.io/auth/users`);
...
function insertUser(obj){
  const post = fetch(`https://64764200e607ba4797dd842e.mockapi.io/auth/users`,{
    method:'POST',
    headers: {
...
async function checkEmail(email){
  let valid = true;
  const promise = await fetch(`https://64764200e607ba4797dd842e.mockapi.io/auth/users`);
